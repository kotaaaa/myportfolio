    ...
    <>
      ...
      <section className="bg-white dark:bg-gray-900 h-fit py-8">
        <div className="py-8 mx-auto max-w-md md:max-w-screen-md content-center">
          <h2 className="mb-4 text-4xl tracking-tight font-black text-center text-gray-900 dark:text-gray-400">
                Posts
          </h2>
            ...
            {allTeckStacks.map((name: string, idx: number) => {
              return (
                <button
                  ...
                  className={`text-xs font-light inline-block py-1 px-2 my-1 mx-1.5 rounded-full text-blue-600 bg-blue-50 last:mr-0 mr-1 dark:bg-gray-300 dark:text-gray-700 ${highLightTab(
                        name
                  )}`} 
                  id={name}
